	...
	plants := []model.Plant{
		{
			...
			Picture:     "https://example.com/plant1.jpg",
			Price:       15_000,
			Status:      "available",
			CreatedAt:   time.Now(),
			UpdatedAt:   time.Now(),
		},
		{
			...
			Picture:     "https://example.com/plant2.jpg",
			Price:       40_000,
			Status:      "available",
			CreatedAt:   time.Now(),
			UpdatedAt:   time.Now(),
		},
		{
			...
			Picture:     "https://example.com/plant3.jpg",
			Price:       75_000,
			Status:      "available",
			CreatedAt:   time.Now(),
			UpdatedAt:   time.Now(),
		...
		{
			PlantID:     uuid.MustParse("25cff48d-bad0-4297-9f73-b025caac08c3"),
			Name:        "Pohon Magnolia",
			Description: "Pohon magnolia dikenal karena bunganya yang indah dan harum. Beberapa spesies magnolia menghasilkan kayu berkualitas tinggi yang sering digunakan dalam industri perkayuan",
			Picture:     "https://example.com/plant3.jpg",
			Price:       17_000,
			Status:      "available",
			CreatedAt:   time.Now(),
